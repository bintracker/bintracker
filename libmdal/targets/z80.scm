(asm-target
 ...
 addressing-modes: ((index-indirect+d->r
		    ...
		    (index-indirect+d
		     (in-parens (sequence* ((reg (register 'i16))
					   ...
					   (result (list 'list `(quote ,reg)
							 displace)))))
		    (memory-indirect (in-parens a-numeric)))
 ...
 instructions:
 ((adc (2 (((is #\a) ((a-numeric (#xce (lsb %op2)))
		      ((register 'r8) ((+ #x88 (register-value %op2))))
		      ((register 'i8) (((extra 'get-prefix) %op2)
				       (+ #x88 (register-value %op2))))
		      ((char-seq "(hl)") (#x8e))
		      ((address 'index-indirect+d) (((extra 'get-prefix)
						     (car %op2))
						    #x8e (cadr %op2)))))
	   ((char-seq "hl") (((register 'r16+sp)
			      (#xed (+ #x4a (register-value %op2)))))))))
  (add (2 (((is #\a) ((a-numeric (#xc6 (lsb %op2)))
  		      ((register 'r8) ((+ #x80 (register-value %op2))))
  		      ((register 'i8) (((extra 'get-prefix) (car %op2))
  ...
  (and (1 ((a-numeric (#xe6 (lsb %op1)))
  	   ((register 'r8) ((+ #xa0 (register-value %op1))))
  	   ((register 'i8) (((extra get-prefix) %op1)
  			    (+ #xa0 (register-value %op1))))
  	   ((char-seq "(hl)") (#xa6))
  	   ((address 'index-indirect+d) (((extra get-prefix) (car %op1))
  					 #xa6 (lsb (cadr %op1)))))))
  (bit (2 (((extra 'bit-range) (((address 'index-indirect+d)
  				 (((extra 'get-prefix) (car %op2))
  				  #xcb (+ #x46 %op1
  				...
  				((register 'r8)
  				 (#xcb (+ #x40 %op1
  					  (register-value %op2)))))))))
  (call (1 ((a-numeric (#xcd (lsb %op1) (msb %op1)))))
  	(2 (((condition 'all) ((a-numeric ((+ #xc4 (condition-value %op1))
  					   (lsb %op2) (msb %op2))))))))
  (ccf (0 (#x3f)))
  (cp (1 ((a-numeric (#xfe (lsb %op1)))
  ...
  (inc (1 (((register 'r8) ((+ #x04 (* 8 (register-value %op1)))))
  	   ...
  	   ((register 'i16) (((extra 'get-prefix) %op1) #x23))
  	   ((char-seq "(hl)") (#x34))
  	   ((address 'index-indirect+d) (((extra 'get-prefix) (car %op1))
  					 #x34 (cadr %op1))))))
  (ind (0 (#xed #xaa)))
  ...
  (ini (0 (#xed #xa2)))
  (inir (0 (#xed #xb2)))
  (jp (1 ((a-numeric (#xc3 (lsb %op1) (msb %op1)))
  	  ((char-seq "(hl)") (#xe9))
  	  ((char-seq "(ix)") (#xdd #xe9))
  	  ((char-seq "(iy)") (#xfd #xe9))))
      (2 (((condition 'all) ((a-numeric ((+ #xc2 (condition-value %op1))
  					   (lsb %op2) (msb %op2))))))))
  (jr (1 (((signed-number-range 8) (#x18 (lsb %op1)))
  	  (a-numeric (#x18 (lsb (- %op1 (+ 2 (current-origin))))))))
      (2 (((condition 'simple)
  	   ((a-number ((+ #x20 (condition-value %op1))
  		       (lsb %op2)))
  	    (a-numeric ((+ #x20 (condition-value %op1))
  ...
  (ld (2 (((is #\a) (((register 'r8) ((+ #x78 (register-value %op2))))
  		     ...
  		     ((address 'index-indirect+d)
  		      (((extra 'get-prefix) (car %op2)) #x7e (cadr %op2)))
		     (a-numeric (#x3e (lsb %op2)))))
  	  ((register 'r8-hl) ((a-numeric ((+ #x06 (* 8 (register-value %op1)))
  	  				  (lsb %op2)))
  	  		      ((register 'r8)
  	  		      ...
  	  		      ((address 'index-indirect+d) ())))
  	  ((register 'h-or-l) ((a-numeric ((+ #x06 (* 8 (register-value %op1)))
  	  				   (lsb %op2)))
  	  		       ((register 'r8)
  	  			((+ #x40 (* 8 (register-value %op1))
  	  			    (register-value %op2))))
	  ...
	  ((char-seq "hl") ((a-numeric (#x21 (lsb %op2) (msb %op2)))
			    ((address 'memory-indirect)
			     (#x2a (lsb %op2) (msb %op2)))))
  	  ((char-seq "sp") (((char-seq "hl") (#xf9))
  	  		    ((register 'i16) (((extra 'get-prefix) %op2)
  	  				      #xf9))
  	  		    (a-numeric (#x31 (lsb %op2) (msb %op2)))))
  	  ((register 'r16+sp) ((a-numeric ((+ #x01 (register-value %op1))
					   (lsb %op2) (msb %op2)))
  	  		       ((address 'memory-indirect)
				(#xed (+ #x4b (register-value %op1))
				      (lsb %op2) (msb %op2)))))
  	  ((register 'i16) ((a-numeric (((extra 'get-prefix) %op1)
					#x21 (lsb %op2) (msb %op2)))
  	  		    ((address 'memory-indirect)
			     (((extra 'get-prefix) %op1)
			      #x2a (lsb %op2) (msb %op2)))))
  	  ((char-seq "(bc)") (((is #\a) (#x02))))
  	  ((char-seq "(de)") (((is #\a) (#x12))))
  	  ((char-seq "(hl)") (((register 'r8) ((+ #x70
  	  					  (register-value %op2))))
  	  		      (a-numeric (#x36 (lsb %op2)))))
  	  ((address 'memory-indirect)
  	   (((is #\a) (#x32 (lsb %op1) (msb %op1)))
  	    ...
  	    ((register 'r16+sp) (#xed (+ #x43 (register-value %op2))
  	  			      (lsb %op1) (msb %op1)))))
  	  ((address 'index-indirect+d)
  	   (((register 'r8) (((extra 'get-prefix) (car %op1))
  	  		     (+ #x70 (register-value %op2))
  	  		     (lsb (cadr %op1))))
  	    ;; TODO verify this composition
  	    (a-numeric (((extra 'get-prefix) (car %op1))
  ...
  (pop (1 (((register 'r16+af) ((+ #xc1 (register-value %op1))))
  	   ((register 'i16) (((extra 'get-prefix) %op1) #xe1)))))
  (push (1 (((register 'r16+af) ((+ #xc5 (register-value %op1))))
  	    ((register 'i16) (((extra 'get-prefix) %op1) #xe5)))))
  (res (2 (((extra 'bit-range)
  	    (((register 'r8) (#xcb (+ #x80 %op1 (register-value %op2))))
  	     ((char-seq "(hl)") (#xcb (+ #x86 %op1)))
  	     ((address 'index-indirect+d) (((extra 'get-prefix) (car %op2))
       ...
       (3 (((extra 'bit-range)
  	    (((address 'index-indirect+d)
  	      (((register 'r8) (((extra 'get-prefix) (car %op2))
  				#xcb (cadr %op2)
  ...
  (rst (1 (((is #\0) (#xc7))
  	   ...
  	   ((char-seq "30") (#xf7))
  	   ((char-seq "38") (#xff)))))
  (sbc (2 (((is #\a) ((a-numeric (#xde (lsb %op2)))
  ...
  (sub (1 (((register 'r8) ((+ #x90 (register-value %op1))))
  	   ...
  	   ((address 'index-indirect+d) (((extra 'get-prefix) (car %op1))
					 #x96 (cadr %op1)))
  	   (a-numeric (#xd6 (lsb %op1))))))
  (xor (1 ((a-numeric (#xee (lsb %op1)))
