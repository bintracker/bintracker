(asm-target
 ...
 ((adc (0 (#x8e)))
  ...
  (bc (1 (((signed-number-range 8) (#x82 (lsb %op1)))
  	  (numeric (#x82 (lsb (- %op1 2 current-origin)))))))
  ...
  (bm (1 (((signed-number-range 8) (#x91 (lsb %op1)))
  	  (numeric (#x91 (lsb (- %op1 2 current-origin)))))))
  (bnc (1 (((signed-number-range 8) (#x92 (lsb %op1)))
  	   (numeric (#x92 (lsb (- %op1 2 current-origin)))))))
  (bno (1 (((signed-number-range 8) (#x98 (lsb %op1)))
  	   (numeric (#x98 (lsb (- %op1 2 current-origin)))))))
  (bnz (1 (((signed-number-range 8) (#x94 (lsb %op1)))
  	   (numeric (#x94 (lsb (- %op1 2 current-origin)))))))
  (bp (1 (((signed-number-range 8) (#x81 (lsb %op1)))
  	  (numeric (#x81 (lsb (- %op1 2 current-origin)))))))
  (br7 (1 (((signed-number-range 8) (#x8f (lsb %op1)))
  	   (numeric (#x8f (lsb (- %op1 2 current-origin)))))))
  ...
  (bz (1 (((signed-number-range 8) (#x84 (lsb %op1)))
  	  (numeric (#x84 (lsb (- %op1 2 current-origin)))))))
  ...
  (ei (0 (#x1b)))
  (inc (0 (#x1f)))
  (ins (1 (((extras 'const-3bit) ((+ #xa %op1))))))
  ...
  (lr (2 (((is #\a) (((register 'rkq) ((register-value %op2)))
	  ...
	  ((char-seq "dc") (((register 'rqh) ((register-value %op2)))))
	  ...
	  ((register 'isar) (((is #\a) ((+ #x50 (register-value %op1))))))
  	  ...
  	  ((is #\j) (((is #\w) (#x1e))))
  	  ((is #\w) (((is #\j) (#x1d))))
  	  ((register 'rqh) (((char-seq "dc") ((+ 1 (register-value %op1)))))))))
  ...
  (om (0 (#x8b)))
  (outs (1 (((extras 'const-3bit) ((+ #xb %op1))))))
