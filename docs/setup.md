...
```sh
$ chicken-install args base64 bitstring comparse coops git imlib2 list-utils matchable pstk simple-md5 sqlite3 srfi-1 srfi-4 srfi-13 srfi-14 srfi-18 srfi-69 stack test typed-records web-colors
```
