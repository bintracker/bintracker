...
If you believe someone is violating the code of conduct, we ask that you report via the official [contact form](https://bintracker.org/contact/). For more details please see the section on [Reporting](#reporting).
...
Any of the parties directly involved or affected can request reconsideration of the team’s decision. To make such a request, contact the Bintracker team via the [contact form](https://bintracker.org/contact/) with your request and motivation and the team will review the case.


## Questions?

If you have questions, feel free to [contact us](https://bintracker.org/contact/).



Text adapted from the [Django Code of Conduct](https://www.djangoproject.com/conduct/).
